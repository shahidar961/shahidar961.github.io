    ...
    return (
        <div className="page-container">
            ...
            <div className="content-section">
                ...
                <div className="paper-item">
                    <p className="paper-description">
                        1. <strong>Credit Constraints and Child Growth: Evidence from Microfinance Ban in India</strong> (with Vinayak Krishnatri & Sukumar Vellakkal) <br />
                        [Draft coming soon]
                    </p>
                </div>
                ...
                <div className="paper-item">
                    <p className="paper-description">
                        2. <strong>From Revenue to Risk: The Reproductive costs of Alcohol Expansion</strong> <br />
                        [Draft coming soon]
                    </p>
                </div>
                ...
                <div className="paper-item">
                    <p className="paper-description">
                        3. <strong>When Programs Work Together: Evidence on the Joint Effects of Two Interventions</strong> <br />
                        [Draft coming soon]
                    </p>
                </div>
            </div>
